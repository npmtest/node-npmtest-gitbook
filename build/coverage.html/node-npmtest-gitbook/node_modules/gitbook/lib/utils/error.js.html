...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-gitbook/node_modules/gitbook/lib/utils/error.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-gitbook/node_modules/gitbook/lib/utils/error.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-gitbook/node_modules/gitbook/lib/utils/</a> &#187; error.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >function enforce(err) {</span>
<span class="cstat-no" title="statement not covered" >    if (is.string(err)) <span class="cstat-no" title="statement not covered" >err = new Error(err);</span></span>
<span class="cstat-no" title="statement not covered" >    err.message = err.message.replace(/^Error: /, '');</span>
&nbsp;
